    ...
    <div class="col-sm-offset-3 col-md-4">
        ...
        <form id="orderConfirm"
            ...
            <div class="form-group">
                <label class="col-sm-5 control-label">Información de Envío</label>
                <div class="col-sm-7">
        ...
        <form id="orderView"
            ...
            <hr>
            <h3> Click <a href='../pages/shipping.php'>here </a> to return to Home Page</h3>
        </form>
    </div>
</div>
